...
def insert_data():
    ...
    cars = {UsedStock(make="Honda", model="Accord", year=2004, fuel_type="Diesel", engine_size="2200cc", seats=5,
            ...
            UsedStock(make="Mazda", model="6", year=2009, fuel_type="Petrol", engine_size="2000cc", seats=5,
            ...
            UsedStock(make="Toyota", model="Avensis", year=2013, fuel_type="Diesel", engine_size="2000cc", seats=5,
                      ...
                      description="12 SERVICES,LAST SERVICED AT 117446 ALL BY MAIN DEALER,SAT-NAV,PARKING CAMERA, " +
                                  ...
                                  "SPEC., Warranties Available, credit/debit cards accepted,FINANCE ARRANGED SUBJECT TO STATUS, & P/X Welcome, £6,595")
            }
    db.session.add(user)
    for car in cars:
        db.session.add(car)
